...
def get_pattern(structure, wavelength, two_theta_range=(0, 90)):
    ...
    # TODO: do not call np.array here
...
if __name__ == "__main__":
    ...
    start = time.time()
    get_pattern(crystal, 1.2, (0, 90))
    stop = time.time()

    print("Took {} s for non-optimized version".format(stop - start))

    start = time.time()
    get_pattern_optimized(crystal, 1.2, (0, 90))
    stop = time.time()

    print("Took {} s for optimized version".format(stop - start))
