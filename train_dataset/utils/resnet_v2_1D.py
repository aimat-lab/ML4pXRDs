# Source: https://github.com/Sakib1263/ResNet-ResNetV2-SEResNet-ResNeXt-SEResNeXt-1D-2D-Tensorflow-Keras/blob/901e13775e9265124bebd7706a1b35035718f3d8/Codes/ResNet_1DCNN.py#L97
# developed by Sakib1263
...
def stem(inputs, num_filters):
    ...
    if conv.shape[1] <= 2:
        pool = tf.keras.layers.MaxPooling1D(pool_size=1, strides=2, padding="valid")(
            conv
        )
    else:
        pool = tf.keras.layers.MaxPooling1D(pool_size=2, strides=2, padding="valid")(
            conv
        )
